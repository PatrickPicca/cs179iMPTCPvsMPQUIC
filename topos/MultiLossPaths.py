...
class CustomTopo(Topo):
    def build(self):
        ...
        self.addLink(client, switch1, cls=TCLink, delay='10ms', loss=5)
        self.addLink(client, switch2, cls=TCLink, delay='10ms', loss=5)
        self.addLink(switch1, switch3, cls=TCLink, delay='200ms', loss=35)
        self.addLink(switch2, switch3, cls=TCLink, delay='50ms', loss=25)
